...
enum eData
{
    DATA_ASSAULT_ON_ZANVESS  = 0,
    DATA_DEFENSES_OF_ZANVESS = 1,
    DATA_HEART_OF_ZANVESS    = 2,
    DATA_WEAPON_OF_ZANVESS   = 3,
    DATA_FACTION,
    DATA_TELVRAK_LINKED,
    DATA_TEAM_LEADER_DEFEATED,
    DATA_REACHED_HEART,
};
...
enum CriteriaTrees
{
    CRITERIA_TREE_ASSAULT_HORDE             = 30958,
    CRITERIA_TREE_KYPARITE_HORDE            = 30960,
    CRITERIA_TREE_WHISPERING_STONES_HORDE   = 30961,
    CRITERIA_TREE_VENOMSTING_PITS_HORDE     = 30962,
    CRITERIA_TREE_TEAM_LEADER_HORDE         = 30967,
    CRITERIA_TREE_REACH_HEART_HORDE         = 30968,
    CRITERIA_TREE_TELVRAK_HORDE             = 30965,

    CRITERIA_TREE_ASSAULT_ALLIANCE          = 31228,
    CRITERIA_TREE_KYPARITE_ALLIANCE         = 31230,
    CRITERIA_TREE_WHISPERING_STONES_ALLIANCE = 31231,
    CRITERIA_TREE_VENOMSTING_PITS_ALLIANCE  = 31232,
    CRITERIA_TREE_TEAM_LEADER_ALLIANCE      = 31234,
    CRITERIA_TREE_REACH_HEART_ALLIANCE      = 31235,
    CRITERIA_TREE_TELVRAK_ALLIANCE          = 31237,
};
