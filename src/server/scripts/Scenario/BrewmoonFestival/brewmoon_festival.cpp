            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    if (eventId == EVENT_BLOODLETTING)
                    {
                        ...
                        events.ScheduleEvent(EVENT_BLOODLETTING, urand(4000, 4500));
                    }
                    break;
                }
...
class npc_disturbed_saurok : public CreatureScript
{
    public:
        ...
        struct npc_disturbed_saurokAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_GASH, urand(4000, 4500));
            }
...
class npc_brewmoon_water_spirit : public CreatureScript
{
    public:
        ...
        struct npc_brewmoon_water_spiritAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_WATER_BOLT, urand(4000, 4500));
            }
                ...
                switch (actionId)
                {
                    case ACTION_INTRO:
                    {
                        ...
                        if (Creature* m_globule = ObjectAccessor::GetCreature(*me, instance ? instance->GetGuidData(NPC_PURE_WATER_GLOBE) : ObjectGuid::Empty))
                        {
                            ...
                            init.Launch();
                            nonCombatEvents.ScheduleEvent(EVENT_WATER_GLOBULE, me->movespline->Duration());
                        }
            ...
            void DoAction(int32 actionId) override
            {
                switch (actionId)
                {
                    ...
                    case ACTION_BREWMOON_FESTIVAL:
                        ...
                        nonCombatEvents.ScheduleEvent(EVENT_BREWMOON_PREPARE, 4500);
                        break;
                }
            }
        ...
        struct npc_brewmaster_boofAI : public ScriptedAI
        {
            ...
            void MovementInform(uint32 type, uint32 pointId) override
            {
                if (pointId == EVENT_JUMP)
                {
                    ...
                    Talk(TALK_SPECIAL_2);
                    nonCombatEvents.ScheduleEvent(EVENT_BREWMOON, 6200);
                }
            }
                ...
                switch (actionId)
                {
                    case ACTION_INTRO:
                        if (Player* triggering = me->FindNearestPlayer(80.0f))
                            Talk(TALK_SPECIAL_1, triggering->GetGUID());
                ...
                while (uint32 eventId = nonCombatEvents.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_DEFENDERS_1:
                            ...
                            nonCombatEvents.ScheduleEvent(EVENT_DEFENDERS_2, 7500);
                            break;
    ...
    public:
        ...
        struct npc_bataari_yaungolAI : public brewmoon_yaungol_typeAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                ...
                events.ScheduleEvent(EVENT_HEROIC_LEAP, urand(8000, 14500));
            }
            ...
            void SetData(uint32 type, uint32 data) override
            {
                ...
                nonCombatEvents.ScheduleEvent(onBloat ? EVENT_BLOAT_PATH : EVENT_PATH, urand(1000, 3500));
            }
                ...
                while (uint32 eventId = nonCombatEvents.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_PATH:
                        {
                            ...
                            init.Launch();
                            nonCombatEvents.ScheduleEvent(EVENT_PATH_END, me->movespline->Duration());
                            break;
                        }
                        case EVENT_PATH_END:
                            me->SetHomePosition(*me);
                        ...
                        case EVENT_BLOAT_PATH:
                            if (TempSummon* m_yBloat = me->SummonCreature(NPC_YAUNGOL_BOAT, *me, TEMPSUMMON_MANUAL_DESPAWN))
                            {
                                ...
                                init.SetVelocity(4.75f);
                                init.Launch();
                                nonCombatEvents.ScheduleEvent(EVENT_BLOAT_PATH_END, m_yBloat->movespline->Duration());
                                m_yBloat->DespawnOrUnsummon(m_yBloat->movespline->Duration() + IN_MILLISECONDS);
                            }
                            break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HEROIC_LEAP:
                            ...
                            events.ScheduleEvent(EVENT_HEROIC_LEAP, urand(13500, 18500));
                            break;
                    }
                }
    ...
    public:
        ...
        struct npc_bataari_flamecallerAI : public brewmoon_yaungol_typeAI
        {
            ...
            void SetData(uint32 type, uint32 data) override
            {
                ...
                nonCombatEvents.ScheduleEvent(EVENT_PATH, urand(1000, 3500));
            }
            ...
            void UpdateAI(uint32 diff) override
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    if (eventId == EVENT_QUICKEN)
                    {
                        ...
                        events.ScheduleEvent(EVENT_QUICKEN, urand(2500, 2800));
                    }
                    break;
                }
...
class npc_bataari_war_yeti : public CreatureScript
{
    public:
        ...
        struct npc_bataari_war_yetiAI : public brewmoon_yaungol_typeAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_YETI_SMASH, urand(9000, 12500));
...
class npc_warbringer_qobi : public CreatureScript
{
    public:
        ...
        struct npc_warbringer_qobiAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                events.ScheduleEvent(EVENT_THROW_OIL, urand(10500, 14000));
