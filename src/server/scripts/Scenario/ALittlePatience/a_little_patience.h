...
#ifndef A_LITTLE_PATIENCE_H_
#define A_LITTLE_PATIENCE_H_
...
const std::map<uint32, std::array<uint32, 3>> invAssaultBindType =
{
    ...
    { TYPE_NIGHT_ELF, { NPC_FERA_PEARL, NPC_NIGHT_ELF_LABORER, SPELL_INSPIRED_NIGHT_ELF } },
    { TYPE_JYUIN,     { NPC_ELDER_ADLER, NPC_FALLSONG_LABORER, SPELL_INSPIRED_JYNUI } },
    { TYPE_PANDAREN,  { NPC_MASTER_BROWNSTONE, NPC_PANDAREN_LABORER, 0 } },
};
