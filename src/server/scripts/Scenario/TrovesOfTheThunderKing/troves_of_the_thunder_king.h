...
#ifndef TROVES_OF_THE_THUNDER_KING_SCENARIO_H_
#define TROVES_OF_THE_THUNDER_KING_SCENARIO_H_
...
enum MiscSpells
{
    ...
    CRITERIA_ASSET_LOOTED_GOLDEN_CHEST = 139578,
};
...
#endif // TROVES_OF_THE_THUNDER_KING_H_
