...
{
    TalkBorkaAggro = 0,     ///< I got this boss [45775]
    ...
    TalkRocketsparkDeath = 0, ///< This was not the plan [43731]
...
static void StartRocketSparkAndBorka(InstanceScript* p_Instance, Creature* p_Me, ObjectGuid const& p_TargetGuid)
{
    ...
    struct boss_rocketsparkAI : public BossAI
    {
        ...
        void DoAction(int32 const p_Action) override
        {
            ...
            case eRocksparkAndBorkaActions::ActionMadDashContact:
                ...
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC);
                break;
            default:
                break;
            }
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            case eRocketsparkEvents::Eventx2101aCancelation:
                ...
                m_x210IsActivated = false;
                me->SetReactState(ReactStates::REACT_AGGRESSIVE);
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_REMOVE_CLIENT_CONTROL);
                break;
...
public:
    ...
    struct grimrail_depot_rocketspark_mob_borkaAI : public BossAI
    {
        ...
        void MovementInform(uint32 /*p_Type*/, uint32 p_Id) override
        {
            ...
            {
                float l_X = me->GetPositionX() + 50 * std::cos(me->GetOrientation());
                float l_Y = me->GetPositionY() + 50 * std::sin(me->GetOrientation());
        ...
        void UpdateAI(uint32 const p_Diff) override
        {
            ...
            {
                if (Creature* l_Creature = Creature::GetCreature(*me, m_MadDashTargetGUID))
                    me->GetMotionMaster()->MoveCharge(l_Creature->GetPositionX(), l_Creature->GetPositionY(), l_Creature->GetPositionZ(), 24.0f, eRocksparkAndBorkaMovementInformed::MovementMadDashContact, false, l_Creature);
