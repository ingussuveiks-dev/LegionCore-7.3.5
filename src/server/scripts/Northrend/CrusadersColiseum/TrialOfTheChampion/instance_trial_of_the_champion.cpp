        ...
        void SetData(uint32 type, uint32 data) override
        {
            switch(type)
            {
                case BOSS_GRAND_CHAMPIONS:
                    ...
                    {
                        DoUpdateAchievementCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_ASSET_CHAMPIONS);
                ...
                case BOSS_ARGENT_CHALLENGE_E:
                    ...
                    if (data == DONE)
                    {
                        if (Creature* announcer = instance->GetCreature(uiAnnouncerGUID))
                        {
                            DoUpdateAchievementCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_ASSET_EADRIC);
                            announcer->GetMotionMaster()->MovePoint(0, 742.742f, 630.207f, 411.172f);
                            announcer->SetFlag(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);
                ...
                case BOSS_ARGENT_CHALLENGE_P:
                    ...
                    if (data == DONE)
                    {
                        if (Creature* announcer = instance->GetCreature(uiAnnouncerGUID))
                        {
                            DoUpdateAchievementCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_ASSET_PALETRESS);
                            DoUpdateAchievementCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_ASSET_MEMORIES);
                            announcer->GetMotionMaster()->MovePoint(0, 742.742f, 630.207f, 411.172f);
                            announcer->SetFlag(UNIT_FIELD_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);
                ...
                case BOSS_BLACK_KNIGHT:
                    ...
                    if (data == DONE)
                        DoUpdateAchievementCriteria(CRITERIA_TYPE_BE_SPELL_TARGET, CRITERIA_ASSET_BLACK_KNIGHT);
                    break;
