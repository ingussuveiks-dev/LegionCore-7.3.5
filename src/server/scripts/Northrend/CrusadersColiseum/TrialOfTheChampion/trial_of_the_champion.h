...
enum achievementCriterias
{
    ...
    // Criteria.db2 assets used by CRITERIA_TYPE_BE_SPELL_TARGET.
    CRITERIA_ASSET_CHAMPIONS       = 68572,
    CRITERIA_ASSET_PALETRESS       = 68574,
    CRITERIA_ASSET_MEMORIES        = 68206,
    CRITERIA_ASSET_EADRIC          = 68575,
    CRITERIA_ASSET_BLACK_KNIGHT    = 68663,
};
